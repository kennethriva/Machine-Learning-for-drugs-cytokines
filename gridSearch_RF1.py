...
list_params = [{ "n_estimators" : [100,500,1000],
                 "max_depth" : [3, 5, 7, 9, 12, 20, None],
                 "max_features": [1, 3, 10,'auto'],
                 "min_samples_split": [2,3,4,5,10,15,20,40],
...
check_predictions_unseen_test_set(list_optimized_models, X_ts_data, y_ts_data, listFiles_ts[0], out_name='sG_RF_'+listFiles_tr)
