...
list_params = [{ "n_estimators" : [100,500,1000],
...
# apply grid search to he previous models and set of parameters
# consider using Randomized search since gridsearch can take so long

# Notice that this grid search strategy which looks for the best combination of parameters used the training data
...
# In[ ]:
# On the other hand we check real performances on the testing data...
